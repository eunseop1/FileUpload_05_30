...
<head>
<meta charset="UTF-8">
<title>Cos 라이브러리를 이용한 업로드</title>
</head>
<body>
	<%
	   ...
	   if (!request.getMethod().equals("POST")) {
	      ...
	      out.println("location.href='uploadForm4.jsp';");
	      out.println("</script>");
	      return;
	   }
	// cos-fileupload 라이브러리를 사용하여 파일을 업로드 한다.
	   ...
	   try {
	      ...
	      //중복 되면 파일 이름 뒤에 1,2,3 ... 이 붙는다
	      
	      //나머지 필드들과 원본 이름/저장이름..을 얻어서 처리하면 된다
	      note = multi.getParameter("note");//일반 폼 필드로 처리
